...
public class MySQLDatabase extends AbstractDatabase {
    ...
    protected void configureHikari() {
        ...
        hc.setJdbcUrl(String.format(
                "jdbc:mysql://%s:%d/%s?useSSL=%b&characterEncoding=utf8&serverTimezone=UTC",
    ...
    protected String ddlClans() {
        return """
                CREATE TABLE IF NOT EXISTS clans (
                    ...
                    home_set     TINYINT(1)   NOT NULL DEFAULT 0,
    ...
    /**
     * MySQL uses INSERT INTO … ON DUPLICATE KEY UPDATE instead of INSERT OR REPLACE.
     * We override insertRelation to use the correct syntax.
     */
    @Override
    public CompletableFuture<Void> insertRelation(
            UUID clanId, UUID targetId, RelationType type) {
        return asyncVoid(() -> {
